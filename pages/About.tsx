...
export default function AboutPage() {
  ...
  return (
    ...
    <Text mt={0} w={{base:"100%",md:"100%"}} mr="auto">
        ...
        その後は勉強&フリーランスの期間を経て、2022年から正社員として旅行会社のWEB部署でUIUXデザイナーとして働き始めました。
        副業でアプリ受託制作会社に業務委託のUIUXデザイナーとして所属しています。<br />
        2024年からSaaSスタート企業にてWEBアプリケーションのプロダクトデザイナーとして勤務しています。
    </Text>
    </Stack>
