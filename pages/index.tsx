  ...
  return (
    ...
    keyword={'ブログ,デザイナー,デザイン,ポートフォリオ'}
     ...
     <LayoutWide>
      ...
      {/* トップ */}
      <Box css={sFull} backgroundImage={"/img/Top/FV.png"} backgroundSize={"cover"}></Box>
      ...
      <Text fontSize={{base:"18px",md:"32px"}} lineHeight="150%">ユーザー視点とビジネス視点をつなぐ<br/>プロダクトデザイナーです</Text>
