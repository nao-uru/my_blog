  ...
  return (
   ...
   <BreadcrumbList
    ...
    <Box m="auto" w="100%" mr={8}>
     ...
     <Box w={{base:"95%",md:"92%"}} m="auto" dangerouslySetInnerHTML={{__html:md.render(blogPost.fields.text)}} />
     </Box>
     ...
     <Flex flexDirection="column" align="center" mt={{base:0, md:8}}>
      ...
      <ButtonPrime 
       ...
       icon={<FaTwitter size={20} color="#151515" />}
       color="#151515"
       bgColor="#ffffff"
      ...
      <ButtonPrime       
       ...
       icon={<FaLine size={20} color="#151515" />}
       color="#2151515"
       bgColor="#ffffff"
       >LINEで送る</ButtonPrime>
      </Box>
